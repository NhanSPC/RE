...
Namespace Data
    Public Class STDBirthDays
        ...
        Public Overrides ReadOnly Property Description As String
            Get
                Return <text>
                           Return all students having birth day occured in a period of time.
                       </text>.Value
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property Syntax As String
            Get
                Return <text>
                           user table(pbs.BO.Data.STDBirthdays?FromDate=...&amp;Todate=...)
                       </text>.Value
            End Get
        End Property
        ...
        Public Overloads Overrides Function GetTable(Arg As pbsCmdArgs) As DataTable
            ...
            'get infoList
            Dim infoList = (From itm In STDInfoList.GetSTDInfoList(filter) Where pbs.Helper.SmartDate.Parse(itm.Dob).ToString("MMdd") >= fromDate And pbs.Helper.SmartDate.Parse(itm.Dob).ToString("MMdd") <= toDate).ToList
